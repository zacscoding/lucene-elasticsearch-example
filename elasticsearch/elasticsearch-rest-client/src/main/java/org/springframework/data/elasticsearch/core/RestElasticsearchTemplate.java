...
// * @author Sascha Woo
// */
//public class RestElasticsearchTemplate implements ElasticsearchOperations, ApplicationContextAware {
//
...
//
//    public RestElasticsearchTemplate(RestHighLevelClient client) {
//        this(client, new MappingElasticsearchConverter(new SimpleElasticsearchMappingContext()));
//    }
//
//    public RestElasticsearchTemplate(RestHighLevelClient client, EntityMapper entityMapper) {
//        this(client, new MappingElasticsearchConverter(new SimpleElasticsearchMappingContext()), entityMapper);
//    }
//
//    public RestElasticsearchTemplate(RestHighLevelClient client, ElasticsearchConverter elasticsearchConverter,
//        EntityMapper entityMapper) {
//        this(client, elasticsearchConverter,
//            new DefaultResultMapper(elasticsearchConverter.getMappingContext(), entityMapper));
//    }
//
//    public RestElasticsearchTemplate(RestHighLevelClient client, ResultsMapper resultsMapper) {
...
//    }
//
//    public RestElasticsearchTemplate(RestHighLevelClient client, ElasticsearchConverter elasticsearchConverter, ResultsMapper resultsMapper) {
//
...
//        throw new UnsupportedOperationException("Not supported. Use getRestHighLevelClient()");
//    }
//
...
//        try {
//            IndexResponse res = client.index(new IndexRequest(indexName));
//            return res.status().getStatus() == 200;
//        } catch(IOException e) {
//
//        }
